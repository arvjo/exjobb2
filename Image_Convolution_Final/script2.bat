...
@echo off
echo       %resolution% images %filter% (BASIC)>>TEST_RESULTS2.txt
echo -------------------------------------------------->>TEST_RESULTS2.txt
echo            ---------CPU-single--------->>TEST_RESULTS2.txt
echo.
...
for /l %%x in (1, 1, !nrOfRuns!) do (
	...
	gpu_advanced.exe !imageName! CPU-single Basic !filter! 0 !displayTime! 0 >>TEST_RESULTS2.txt
	<nul set /p = ^>
	IF %%x GEQ !c! (
		echo.
		set /a c=c+50
...
echo -------------------------------------------------->>TEST_RESULTS2.txt
echo       %resolution% images %filter% (BASIC)>>TEST_RESULTS2.txt
echo            ---------CPU-Multi---------->>TEST_RESULTS2.txt
echo.
echo            ---------CPU-Multi----------
set /a c=50
setlocal ENABLEDELAYEDEXPANSION
for /l %%x in (1, 1, !nrOfRuns!) do (
	...
	gpu_advanced.exe !imageName! CPU Basic !filter! 0 !displayTime! 0 >>TEST_RESULTS2.txt
	<nul set /p = ^>
	IF %%x GEQ !c! (
		echo.
		set /a c=c+50
...
echo -------------------------------------------------->>TEST_RESULTS2.txt
echo       %resolution% images %filter% (BASIC)>>TEST_RESULTS2.txt
echo            ---------GPU-Multi---------->>TEST_RESULTS2.txt
echo.
echo            ---------GPU-Multi----------
set /a c=50
setlocal ENABLEDELAYEDEXPANSION
for /l %%x in (1, 1, !nrOfRuns!) do (
	...
	gpu_advanced.exe !imageName! GPU Basic !filter! 0 !displayTime! 0 >>TEST_RESULTS2.txt
	<nul set /p = ^>
	IF %%x GEQ !c! (
		echo.
		set /a c=c+50
...
echo       %resolution% images %filter% (OPTIMIZED)>>TEST_RESULTS2.txt
echo -------------------------------------------------->>TEST_RESULTS2.txt
echo            ---------CPU-Multi---------->>TEST_RESULTS2.txt
echo.
...
for /l %%x in (1, 1, !nrOfRuns!) do (
	...
	gpu_advanced.exe !imageName! CPU Optimized !filter! 0 !displayTime! 0 >>TEST_RESULTS2.txt
	<nul set /p = ^>
	IF %%x GEQ !c! (
		echo.
		set /a c=c+50
...
for /l %%x in (1, 1, !nrOfRuns!) do (
	...
	gpu_advanced.exe !imageName! GPU Optimized !filter! 0 !displayTime! 0 >>TEST_RESULTS2.txt
	<nul set /p = ^>
	IF %%x GEQ !c! (
		echo.
		set /a c=c+50
